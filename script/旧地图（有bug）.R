...
df.se <- left_join(df.se, states) %>%
  ...
  mutate(PINYIN_NAM = if_else(PINYIN_NAM == "Guangxi", "Guangxi Zhuang", PINYIN_NAM)) %>%
  mutate(PINYIN_NAM = if_else(PINYIN_NAM == "Ningxia", "Ningxia Hui", PINYIN_NAM)) %>%
  mutate(PINYIN_NAM = if_else(PINYIN_NAM == "Xinjiang", "Xinjiang Wei", PINYIN_NAM)) %>%
  mutate(PINYIN_NAM = if_else(PINYIN_NAM == "Chongqing", "chongqingshi", PINYIN_NAM)) %>%
